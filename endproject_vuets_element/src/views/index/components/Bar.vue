...
<!--  <el-radio-group v-model="selectLabel"  @change="dayChange">
    <el-radio-button label="total_" >确诊</el-radio-button>
    <el-radio-button label="total_" >治愈</el-radio-button>
    <el-radio-button label="total_" >死亡</el-radio-button>
  </el-radio-group>-->
  ...
  const option = {
    ...
    series: [
      ...
      },
      {
        ...
        data: deathdata//deathdata.toString()
      }
    ]
  };
