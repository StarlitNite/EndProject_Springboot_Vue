...
import {msgList, sessionListAlready} from "../../request/api";
export default {
  ...
  methods: {
    ...
    loginOrRegister(){
      ...
      if(this.dialogTitle == "注册"){
        axios.get('http://localhost:8000/register?name=' + this.loginName)
        ...
        axios.get('http://localhost:8000/login?name=' + this.loginName)
            .then(function (response) {
    ...
    getSessionListNot(){
      let thus = this
      axios.get('http://localhost:8000/sessionList/not?id=' + this.curUserId)
          .then(function (response) {
            if(response.data.code == -1){
              return thus.$message.error(response.data.errDesc);
            }
    ...
    sessionListAlready(){
      let thus = this
      axios.get('http://localhost:8000/sessionList/already?id=' + this.curUserId)
          .then(function (response) {
            if(response.data.code == -1){
              return thus.$message.error(response.data.errDesc);
            }
    ...
    createSession(toUserId, toUserName){
      let thus = this
      axios.get('http://localhost:8000/createSession?id=' + this.curUserId + "&toUserId=" + toUserId + "&toUserName=" + toUserName)
          .then(function (response) {
            if(response.data.code == -1){
              return thus.$message.error(response.data.errDesc);
            }
    ...
    delSession(sessionId){
      let thus = this
      axios.get('http://localhost:8000/delSession?sessionId=' + sessionId)
          .then(function (response) {
            if(response.data.code == -1){
              return thus.$message.error(response.data.errDesc);
            }
    ...
    loginOut(){
      let thus = this
      axios.get('http://localhost:8000/loginOut?name=' + this.curUserName)
          .then(function (response) {
            if(response.data.code == -1){
              return thus.$message.error(response.data.errDesc);
            }
    ...
    msgList(sessionId){
      let thus = this
      axios.get('http://localhost:8000/msgList?sessionId=' + sessionId)
          .then(function (response) {
            if(response.data.code == -1){
              return thus.$message.error(response.data.errDesc);
            }
